...
public class CardManager : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        //CardManagerList.AllCards.Add(new Card("Ensign", 1, 5, 1, 4, "Unit", true, cardModels[1]));
        CardManagerList.AllCards.Add(new Card("Mystan", 1, 1, 1, 4, "Unit", true, cardModels[5]));
